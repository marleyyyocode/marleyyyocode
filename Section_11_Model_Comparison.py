...
plt.plot(y_test_real, label='Valores Reales', color='blue', linewidth=2, alpha=0.8)

# Graficar predicciones de cada modelo (usando variables _real de secciones 7-10)
plt.plot(y_pred_real, label='Baseline', color='gray', linestyle='--', linewidth=1.5, alpha=0.7)
plt.plot(y_pred_lstm_real, label='LSTM Univariado', color='green', linestyle='-', linewidth=1.5, alpha=0.7)
plt.plot(y_pred_cnn_real, label='CNN Univariado', color='red', linestyle='-', linewidth=1.5, alpha=0.7)
plt.plot(y_pred_lstm_multi_real, label='LSTM Multivariado', color='purple', linestyle='-', linewidth=1.5, alpha=0.7)
